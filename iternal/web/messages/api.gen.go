...
// PutMessagesIdJSONRequestBody defines body for PutMessagesId for application/json ContentType.
type PutMessagesIdJSONRequestBody = Message
...
type ServerInterface interface {
	...
	// Delete a message
	// (DELETE /messages/{id})
	DeleteMessagesId(ctx echo.Context, id Idurl) error
	// Update a message
	// (PUT /messages/{id})
	PutMessagesId(ctx echo.Context, id Idurl) error
}
...
// PutMessagesId converts echo context to params.
func (w *ServerInterfaceWrapper) PutMessagesId(ctx echo.Context) error {
	var err error
	// ------------- Path parameter "id" -------------
	var id Idurl
	...
	// Invoke the callback with all the unmarshaled arguments
	err = w.Handler.PutMessagesId(ctx, id)
	return err
}
...
func RegisterHandlersWithBaseURL(router EchoRouter, si ServerInterface, baseURL string) {
	...
	router.PUT(baseURL+"/messages/:id", wrapper.PutMessagesId)
...
type DeleteMessagesId200JSONResponse string
...
type DeleteMessagesId404JSONResponse string

func (response DeleteMessagesId404JSONResponse) VisitDeleteMessagesIdResponse(w http.ResponseWriter) error {
	w.Header().Set("Content-Type", "application/json")
	w.WriteHeader(404)
...
type DeleteMessagesId500JSONResponse string

func (response DeleteMessagesId500JSONResponse) VisitDeleteMessagesIdResponse(w http.ResponseWriter) error {
	w.Header().Set("Content-Type", "application/json")
	w.WriteHeader(500)
...
type PutMessagesIdRequestObject struct {
	Id   Idurl `json:"id"`
	Body *PutMessagesIdJSONRequestBody
}

type PutMessagesIdResponseObject interface {
	VisitPutMessagesIdResponse(w http.ResponseWriter) error
}

type PutMessagesId201JSONResponse Message

func (response PutMessagesId201JSONResponse) VisitPutMessagesIdResponse(w http.ResponseWriter) error {
	w.Header().Set("Content-Type", "application/json")
	w.WriteHeader(201)
...
type StrictServerInterface interface {
	...
	// Update a message
	// (PUT /messages/{id})
	PutMessagesId(ctx context.Context, request PutMessagesIdRequestObject) (PutMessagesIdResponseObject, error)
}
...
func (sh *strictHandler) DeleteMessagesId(ctx echo.Context, id Idurl) error {
...
// PutMessagesId operation middleware
func (sh *strictHandler) PutMessagesId(ctx echo.Context, id Idurl) error {
	var request PutMessagesIdRequestObject

	request.Id = id

	var body PutMessagesIdJSONRequestBody
	if err := ctx.Bind(&body); err != nil {
		return err
	}
	request.Body = &body
	...
	handler := func(ctx echo.Context, request interface{}) (interface{}, error) {
		return sh.ssi.PutMessagesId(ctx.Request().Context(), request.(PutMessagesIdRequestObject))
	}
	for _, middleware := range sh.middlewares {
		handler = middleware(handler, "PutMessagesId")
	}
	...
	if err != nil {
		return err
	} else if validResponse, ok := response.(PutMessagesIdResponseObject); ok {
		return validResponse.VisitPutMessagesIdResponse(ctx.Response())
	} else if response != nil {
		return fmt.Errorf("unexpected response type: %T", response)
	}
	return nil
