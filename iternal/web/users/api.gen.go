...
type ServerInterface interface {
	...
	// Delete a user
	// (DELETE /users/{id})
	DeleteUsersId(ctx echo.Context, id Idurl) error
	// Update a user
	// (PUT /users/{id})
	PutUsersId(ctx echo.Context, id Idurl) error
}
...
type DeleteUsersId200JSONResponse string
...
type DeleteUsersId404JSONResponse string
...
type DeleteUsersId500JSONResponse string
...
type PutUsersId201JSONResponse User

func (response PutUsersId201JSONResponse) VisitPutUsersIdResponse(w http.ResponseWriter) error {
	w.Header().Set("Content-Type", "application/json")
	w.WriteHeader(201)
...
func (sh *strictHandler) DeleteUsersId(ctx echo.Context, id Idurl) error {
...
func (sh *strictHandler) PutUsersId(ctx echo.Context, id Idurl) error {
